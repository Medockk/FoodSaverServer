...
internal class InvalidGoogleTokenException(message: String = ""): GlobalError(message) {

    override val httpStatus: HttpStatus = HttpStatus.BAD_REQUEST
    override val customCode: ServerErrorCode = AuthErrorCode.INVALID_GOOGLE_TOKEN
}