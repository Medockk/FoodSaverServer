package com.foodback.core.coreCommon.api.errorHandler
...
import com.foodback.core.coreCommon.api.errorCode.CommonErrorCode
    ...
    fun handleMaxUploadSizeExceededException(e: MaxUploadSizeExceededException): ResponseEntity<GlobalErrorResponse> {
        ...
        return ResponseEntity
            ...
            .body(GlobalErrorResponse(
                ...
                httpCode = HttpStatus.BAD_REQUEST.value(),
                serverErrorCode = CommonErrorCode.LARGE_FILE.code
            ))
    }
        ...
        return ResponseEntity
            ...
            .body(
                GlobalErrorResponse(
                    ...
                    serverErrorCode = e.getCustomCode()
                )
            )
    }
